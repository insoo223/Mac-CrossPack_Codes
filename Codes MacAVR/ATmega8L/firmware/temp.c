/**************************************************************
 ...
 HEX size[Byte]: 1002 out of 1024
...
uint8_t cnt8sec=0;
//uint8_t recPeriod=0, cnt800sec=0;
...
void eepromTest()
{
    ...
    /*
     ...
     {
     show2digits(i, 1);
     eeprom_write_byte((uint8_t*)i,i*3);
     //eeprom_write_byte((uint8_t*)(i*2+1),i*3);
     _delay_ms(20);
     }
     */
    ...
    {
        show2digits(i, 1);
        ByteOfData = eeprom_read_byte((uint8_t*)(0+i));
...
void getTemperature(uint8_t SHOW, uint8_t REC)
{
    ...
    if(dht_gettemperaturehumidity(&temperature, &humidity) != -1)
    {
        ...
        if (REC)
        {
            eeprom_write_byte((uint8_t *)cnt8sec,temperature);
        }
