/**************************************************************
 ...
 Description: Timer with 7 segment LED on ATtiny2313A cumstom board
    - History of timer usage is recored at the EEPROM
 
 How to upload hex to target MCU using usbtiny programmer:
 
 cd "/Users/insoo/Google Drive/Coding/Ard/AVR/Tiny2313A/firmware"
 
 avrdude -c usbtiny -P usb -p attiny2313 -U flash:w:main.hex:i
