...
uint8_t _7segLowerPin; //common cathode 7seg GND of ones digit
uint8_t _7segHigherPin; //common cathode 7seg GND of tens digit
...
uint8_t MCU7segPin[8] = {2, 3, 6, 5, 4, 1, 0, 7};  // ATtiny2313A pin
